...
namespace CANOpen
{
    ...
    namespace status
    {
        ...
        namespace value
        {
            ...
            uint16_t const HOMING_COMPLETE_STATE =
                masks::QUICK_STOP | masks::VOLTAGE_ENABLED | masks::OPERATION_ENABLE | masks::SWITCHED_ON |
                masks::READY_TO_SWITCH_ON | masks::TARGET_REACHED | masks::SETPOINT_ACKNOWLEDGE;
